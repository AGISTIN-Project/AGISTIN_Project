...
prm_vsm(8,:) = {'Tp_rise0'      7.5   7.5  11   10 10};
prm_vsm(9,:) = {'Tp_fall0'      7.5   7.5  11   10 10};
...
prm_vsm(20,:) = {'Tp_rise2'    37.2  37.2  11      4 4};
prm_vsm(21,:) = {'Tp_rise9'     0     0    11      4 4};
prm_vsm(22,:) = {'Tp_fall2'    37.2  37.2  11      4 4};
